...
public class ReservationCategorieServlet extends HttpServlet {
			...
			throws ServletException, IOException
	{
		...
		String numS, dateS, heureS, nomC, nbPlaces;
			...
			if (nomC != null && nbPlaces != null)
			{
				...
				try {
					if (BDCategories.getCategorie(nomC) != null )
					{
						...
						{
							RequestDispatcher dispatcher = req.getRequestDispatcher("/Reservation");
		...
		else 
		{
			...
			out.println("<hr><p><font color=\"#FFFFFF\"><a href=\"/Programme\">Retour au programme</a></p>");
		}
	...
	public static void printForm(ServletOutputStream out, String numS, String dateS, String heureS) throws IOException
	{
		...
		out.println("<br>");
		out.println("<input type=\"radio\" name=\"nomC\" value=\"poulaillier\" id=\"poulaillier\" /> <label for=\"poulaillier\">poulaillier   10E par place</label><br />" +
				"<input type=\"radio\" name=\"nomC\" value=\"balcon\" id=\"balcon\" /> <label for=\"balcon\">balcon   25E par place</label><br /> "+
			"<input type=\"radio\" name=\"nomC\" value=\"orchestre\" id=\"orchestre\" /> <label for=\"orchestre\">orchestre   35E par place</label><br />");  
		out.println("<br>");
